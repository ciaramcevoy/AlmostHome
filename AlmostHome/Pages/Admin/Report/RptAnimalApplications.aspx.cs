...
{
    public partial class RptAnimalApplications : System.Web.UI.Page
    {
        ...
        public void BindReportGrid()
        {
            ...
            DataSet ds = Reporting.GetAnimalApplication(from, to);
        ...
        public void SetReportDetails(int rowCount)
        {
            ...
            lblReporTitle.Text = "Animal Applications Report";
        ...
        protected void btnDownload_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=AnimalApplicationsReport.pdf");
